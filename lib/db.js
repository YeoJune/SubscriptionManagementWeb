...
function initDatabase() {
  ...
  db.run(`
-- 2. 기본 히어로 슬라이드 데이터 삽입 (선택사항)
INSERT INTO hero_slides (title, subtitle, images, is_active, display_order) VALUES 
(
  'Saluv All Day', 
  '기분이 좋아지는 음식, 건강한 하루를 만들어가세요',
  '["/public/images/home_hero_0.jpg","/public/images/home_hero_1.jpg","/public/images/home_hero_2.jpg","/public/images/home_hero_3.jpg"]',
  1,
  0
);
    `);
