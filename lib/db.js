...
function initDatabase() {
  ...
  db.run(`
    ALTER TABLE inquiries ADD COLUMN payment_requested BOOLEAN DEFAULT FALSE;
    `);

  db.run(`
    
ALTER TABLE inquiries ADD COLUMN payment_amount INTEGER;`);
  db.run(`
ALTER TABLE inquiries ADD COLUMN payment_requested_at TIMESTAMP;`);
