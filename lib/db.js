...
function initDatabase() {
  ...
  // 결제 테이블에 depositor_name, cancelled_reason 컬럼 추가 (임시)
  db.run(`
    ALTER TABLE payments ADD COLUMN depositor_name TEXT;
ALTER TABLE payments ADD COLUMN cancelled_reason TEXT;
  `);
